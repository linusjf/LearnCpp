...
#pragma omp parallel
  {
    ...
    printf("Thread id: %d,  processed: %lu nodes, took: %f seconds \n",
...
#pragma omp atomic
  ...
  std::cout << "end. processed " << totalProcessedCounter << " nodes. took "
            << elapsed << " in total " << std::endl;
